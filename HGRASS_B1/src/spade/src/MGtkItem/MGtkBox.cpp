...
void MGtkBox::getXmlNodeProperties(xmlNode* node)
{
  ...
  while(attPtr != NULL)
  {
    ...
    else if(!xmlStrcmp(attPtr->name, sBoxDir_IB))
      this->dir = atoi((char*)value);
...
bool MGtkBox::isValidEvent(MGtkEvent* pevent)
{
