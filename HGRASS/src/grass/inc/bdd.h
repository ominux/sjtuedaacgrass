...
#include "..\inc\hashcach.h"
#include "..\inc\tnode.h"
#include "..\inc\intobj.h"
#include "..\inc\bv.h"
#include "..\inc\list.h"
#include "..\inc\odlist.h"
#include "..\inc\indarray.h"
#include "..\inc\floatobj.h"
#include "..\inc\hasharry.h"
#include "..\inc\unate_info.h"
////////////////////////////////////////////////////////////////////////////
...
class BDDnode : public Tnode {
 ...
 public:
  ...
  void PrintWithManager(BDDmanager *,HasherTree* ht,std::ostream& out = cout);
...
public:
 ...
 ~BDDmanager();
  ...
  void PrintStructure(BDDnode *, std::ostream& out = cout);
  void PrintCubes(BDDnode *, char eol, std::ostream& out = cout);
  void PrintCubes(BDDnode *f, std::ostream& out = cout)
                { PrintCubes(f, '\n', out); }
  void PrintLabeledCubes(BDDnode *, char **var_names, int name_len=1,
             char eol='\n', std::ostream& out = cout);
  void Dump(std::ostream& out=cout);
  void WriteBinary(List *, std::ostream& out);
...
///////
  ...
  void        FindRLE();
  void     CountFunctions(integer index, std::ostream& out = cout);
  void       CheckReferenceCounts( std::ostream& out = cout);
  void       ProfileBDDnodes( std::ostream& out = cout);
...
///////
  void     PrintStructureR(BDDnode *, HasherTree *ht, std::ostream& out = cout);
  void     PrintCubesR( BDDnode *, string, std::ostream& out = cout, char eol='\n');
  void PrintLabeledCubesR(BDDnode *, string, std::ostream& out = cout, char eol='\n',
  ...
  void     WriteBinaryR(BDDnode *, std::ostream &out, HasherTree *);
