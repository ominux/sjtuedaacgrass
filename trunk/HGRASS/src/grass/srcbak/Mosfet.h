...
public:
  ...
  virtual map<char*,double>* getDeviceMap(Mosfet* pMosfet) = 0;
protected:
...
public:
  ...
  map<char*,double>* getDeviceMap(Mosfet* pMosfet);
protected:
...
public:
  ...
  {rd = NULL; rs = NULL; rbd = NULL; rbs = NULL;
   KPVOV = 0; LAMVOV = 0; KPID = 0; LAMID=0;}
...
protected:
  ...
  void calKPVOV(MosfetModelBsim3V3* pModel, double val, double w, double l);
  void calLAMVOV(MosfetModelBsim3V3* pModel, double val, double w, double l);
  void calKPID(MosfetModelBsim3V3* pModel, double val, double w, double l);
  void calLAMID(MosfetModelBsim3V3* pModel, double val, double w, double l);
...
public:
  ...
  map<char*,double>* getModelDevices();
